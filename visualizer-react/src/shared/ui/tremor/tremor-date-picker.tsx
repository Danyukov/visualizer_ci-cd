...
import { CalendarDaysIcon as RiCalendar2Fill, MinusIcon as RiSubtractFill } from 'lucide-react'
import * as React from 'react'
import { tv } from 'tailwind-variants'

import { cn, focusInput, focusRing, hasErrorInput } from '@/shared/lib/utils'

import type { Matcher } from './tremor-calendar'

import { Button } from './tremor-button'
import { Calendar as CalendarPrimitive } from './tremor-calendar'
...
function formatDate(date: Date, locale: Locale, includeTime?: boolean): string {
              ...
              {showTimePicker && (
                <div className="flex items-center justify-evenly gap-x-3 border-t border-gray-200 p-3 dark:border-gray-800">
                  <div className="flex flex-1 items-center gap-x-2">
                    ...
                    <TimeInput
                      value={startTime}
                      onChange={(v: any) => onTimeChange(v, 'start')}
                  ...
                  <div className="flex flex-1 items-center gap-x-2">
                    ...
                    <TimeInput
                      value={endTime}
                      onChange={(v: any) => onTimeChange(v, 'end')}
...
function validatePresets(presets: DateRangePreset[] | DatePreset[], rules: PickerProps) {
